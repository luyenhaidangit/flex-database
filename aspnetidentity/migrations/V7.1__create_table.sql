...
-- SCRIPT: V7.1_create_table.sql - 07/06/2025
...
SELECT
    ...
    json_value(r.REQUESTED_DATA, '$.Code' RETURNING VARCHAR2(100))        AS CODE,
    json_value(r.REQUESTED_DATA, '$.Name' RETURNING VARCHAR2(200))        AS NAME,
    json_value(r.REQUESTED_DATA, '$.Description' RETURNING VARCHAR2(500)) AS DESCRIPTION,
    json_value(r.REQUESTED_DATA, '$.IsActive' RETURNING VARCHAR2(5))      AS IS_ACTIVE
